    ...
    def forward(
        ...
        for block in self.transformer_blocks:
            if self.training and self.gradient_checkpointing:
                ...
                def create_custom_forward(module, height, width, return_dict=None):
                    def custom_forward(*inputs):
                        if return_dict is not None:
                            ...
                            return module(*inputs, height=height, width=width)
                ...
                hidden_states = torch.utils.checkpoint.checkpoint(
                    create_custom_forward(block, height=height, width=width),
                    hidden_states,
                    attention_mask,
