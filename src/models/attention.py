...
class BasicTransformerBlock(nn.Module):
    ...
    def __init__(
        ...
        # self.epi_attn = Attention(
        #     query_dim=dim,
        #     heads=num_attention_heads,
        #     dim_head=attention_head_dim,
        #     dropout=dropout,
        #     bias=attention_bias,
        #     cross_attention_dim=dim,  # Epi-Attn uses the same query and key dimension
        #     upcast_attention=upcast_attention,
        # )
        ...
        if cross_attention_dim is not None or double_self_attention:
            ...
            # print(dim, cross_attention_dim, num_attention_heads, attention_head_dim)  # 320, 768, 8, 40
            # print("BasicTransformerBlock: ", self.attn2)
            """
            BasicTransformerBlock:  Attention(
...
class TemporalBasicTransformerBlock(nn.Module):
    def __init__(
        ...
        if cross_attention_dim is not None:
            ...
            # print(dim, cross_attention_dim, num_attention_heads, attention_head_dim)  # 1280 768 8 160
            # print("TemporalBasicTransformerBlock: ", self.attn2)
            """
            TemporalBasicTransformerBlock:  Attention(
