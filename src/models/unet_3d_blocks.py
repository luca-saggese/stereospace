...
class UNetMidBlock3DCrossAttn(nn.Module):
    ...
    def forward(
        ...
        hidden_states = self.resnets[0](hidden_states, temb, dense_emb)
        for attn, resnet, motion_module in zip(
            ...
            hidden_states = resnet(hidden_states, temb, dense_emb)
...
class DownBlock3D(nn.Module):
    ...
    def forward(
        self, hidden_states, temb=None, dense_emb=None, encoder_hidden_states=None
    ):
        output_states = ()
